...
def test_create_summaries_invalid_json(test_app):
    """test handle error when an invalid json is passed"""
...
def test_read_summary(test_app, monkeypatch):
    """test get a summary, mocking the db query"""
    test_data = {
        "id": 1,
        "url": "https://foo.bar",
        "summary": "summary",
...
def test_read_all_summaries(test_app, monkeypatch):
    """test get all summaries, mocking the db query"""
    test_data = [
        {
            "id": 1,
            "url": "https://foo.bar",
...
def test_remove_summary_incorrect_id(test_app, monkeypatch):
    """
    test the errorn handling when an incorrect id is passed,
...
def test_update_summary(test_app, monkeypatch):
    """test update a summary, mocking the db query"""
...
def test_update_summary_invalid_url(test_app):
    """test the error handling when an invalid url is passed"""
    response = test_app.put(
        "/summaries/1/",
